# 12 Senior Q&A (3-min verbal format)

> Practice each out loud, timed at 3 minutes. Goal: skeleton answers you can flesh out under pressure.

> See also: `01-mental-models.md` (the deep material behind these answers) · `02-react19-cheatsheet.md` (quick ref).
...
- **Speak, don't read** — record yourself and listen back. The setting is verbal.
...
*See also: `01-mental-models.md` (deep dives) · `04-practice-drills.md` (live coding + system design) · `05-resources.md` (further reading).*
